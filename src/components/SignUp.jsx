...
const Register = () =>{
    ...
    return(
        ...
        <div className="bg-gray-400 dark:bg-gray-900">
            <section className="min-h-screen flex-shrink-0">
                <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    ...
                    <div className="w-full bg-neutral-300 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                                ...
                                <input type="submit" value="Register" className="relative inline-flex text-white bg-gradient-to-br from-red-500 via-red-400 to-yellow-300 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center" onClick={handleSubmit} />
